from util import tryHandshake

#cbc_hello = ''
...
class PoodleTest :
    ...
    def start(self) :
        self._result.addResult('poodle_ssl3', self._result.getResult('offer_ssl3') and tryHandshake(self._host, self._port, cbc_hello) != -1)
